...
|                  | Name                     | Date     |
|:---------------|:-------------------------|:-----------|
|   Authored by: | Charlotte Micheloud[^1] | 2026-07-13 |
|   Reviewed by: |  Alan Haynes[^2]        | 2026-07-13 |
...
[^1]: Biostatistician, Swiss Cancer Institute, Bern
...
-   The RA is signed up as 'observer' on the [validation tests GitHub repository](https://github.com/SwissClinicalTrialOrganisation/validation_tests)
and received a notification every time a Pull Request is made.
