...
Once merged, the tests can be run via `SCTORvalidation::test("packagename")` and documented in the repository at [https://github.com/SwissClinicalTrialOrganisation/validation_platform](https://github.com/SwissClinicalTrialOrganisation/validation_platform).
