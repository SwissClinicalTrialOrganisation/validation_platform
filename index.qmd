...
d <- data.frame(prod = "Product\nrisk", 
           ...
           pkg_high = c("No function testing required", 
                        "Function testing required", 
                        "Function testing required")) |> 
  mutate(across(starts_with("pkg"), ~factor(.x, levels = c("No function testing required", "Function testing required")))) 
d |> 
  ...
  data_color(columns = pkg_high, 
             method = "factor",
             palette = rev(c("#91cf60", "#fc8d59")),
             domain = levels(d$pkg_high),
             ) |> 
