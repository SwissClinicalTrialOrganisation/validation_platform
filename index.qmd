...
-   **IT Infrastructure level** (IT infrastructure qualification
    *according to **local CTU processes**, see @sec-it-iq*[^5]):
...
-   R is running using a validated base installation version, and
-   a qualified IT infrastructure
...
Table 3 [lists]{.mark} all documentation that is typically
...
|                    |                               |   periodic review          |
|                    | -   Example available on the  |   cycles. The review       |
|                    |     SCTO platform             |   process should be        |
...
|                    | **Example:**                  |       executed or          |
|                    |                               |       specific document    |
|                    | -   Example available on the  |       updates required     |
|                    |     SCTO platform             |       for a newly          |
|                    |                               |       released version.    |
|                    |                               |       Instead, it would    |
|                    |                               |       contain generic      |
|                    |                               |       rules for test       |
...
|                    | -   Example available on the  |   OR if any of the         |
|                    |     SCTO platform             |   existing requirements    |
...
|                    |     document as a basis for   |   of R. If new             |
|                    |     this document ([link to   |   requirements are added   |
|                    |     document]{.mark})         |   to the User              |
|                    |                               |   Requirements             |
...
: Table 3: R Base Installation Validation: Detailed Description of
...
|                    |                               |                            |
|                    | ***R add-on package specific  | - *See section*            |
|                    | approach***: Covered by the   |   [10]{.mark} Periodic     |
|                    | Vendor Assessment created     |   Review                   |
...
|                    | criteria for productive use   | - *See section*            |
|                    | (Validation Plan). The Test   |   [10]{.mark} Periodic     |
|                    | Plan may be included in the   |   Review                   |
...
|                    |                               |                            |
|                    | - [SCTO R add-on Package      |                            |
|                    |   Risk Assessment SOP]{.mark} |                            |
|                    |                               |                            |
|                    | - [SCTO R add-on Package      |                            |
|                    |   Function Testing SOP]{.mark}|                            |
+--------------------+-------------------------------+----------------------------+
| R add-on Package   | **Purpose:**                  | **Required for R add-on    |
|                    |                               | package validation:**      |
| **Validation       | The purpose of such a         |                            |
...
-   **R Package level** (R add-on packages, *see* [**SCTO R add-on
    Package Risk Assessment SOP**]{.mark})
