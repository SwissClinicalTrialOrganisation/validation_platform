...
## Packages with risk assessments
...
tmp <- pkgs |> 
  ...
  select(package, version, final_score, final_score_cat, url, functions, test_result) |> 
  mutate(test_result = if_else(is.na(test_result), " ", test_result))
