...
(https://swissclinicaltrialorganisation.github.io/SCTORvalidation_Rpackage/articles/contribute.html).
...
[here](https://swissclinicaltrialorganisation.github.io/SCTORvalidation_Rpackage/articles/contribute.html){target="_blank"}.
...
[https://github.com/SwissClinicalTrialOrganisation/validation_platform/issues](https://github.com/SwissClinicalTrialOrganisation/validation_platform/issues){target="_blank"}
. Select "New issue". Select the "Add package/function testing results".
Fill out the predefined form, using the output from R
(`SCTORvalidation::test("packagename")`).
