...
|                |     SCTO Risk Metrics)                              |
|                | 3.  Determine, if testing is required (see          |
|                |     @sec-risk-management)                           |
...
| High-Level     | described in the **SCTO Risk metrics**.             |
| Risk           |                                                     |
| Assessment     | The R add-on package high-level risk assessment     |
...
|                | function for that product (see @sec-risk-management).|
+----------------+-----------------------------------------------------+
...
local level):
  ...
  **Product   Low      **No** function    **No** function    **No** function
  Risk**               testing required   testing required   testing required

              Medium   **No** function    **No** function    Function testing
                       testing required   testing required   required

              High     **No** function    Function testing   Function testing
...
# Associated Documents
  ...
  **Reference Title**                                                                                                                                                                                                                                               **Description**
  ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -----------------------------------
  [R Package Risk                                                                                                                                                                                                                                                   This document describes the metrics
  Metrics](https://unibe365-my.sharepoint.com/:w:/r/personal/marie_roumet_unibe_ch/Documents/SCTO_platform/Validation_taskforce/SCTO_Stats_R_Package_metrics/SCTO_R_Package_Metrics_DRAFT_20240319.docx?d=w1f651453facf4acfa11e55d9f9448011&csf=1&web=1&e=hPIyUc)   defining the risk of R add-on
                                                                                                                                                                                                                                                                    packages.

  [R Function Testing                                                                                                                                                                                                                                               This document describes the
  SOP](https://unibe365-my.sharepoint.com/:w:/r/personal/marie_roumet_unibe_ch/Documents/SCTO_platform/Validation_taskforce/SCTO_Stats_Standardized_Procedures/scto_STAT_Function_testing.docx?d=w4d3c0c5c5d5d4799a5711efadc62de93&csf=1&web=1&e=DccKtz)            standard process for testing
                                                                                                                                                                                                                                                                    specific functions within an R
                                                                                                                                                                                                                                                                    add-on package.
  -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
