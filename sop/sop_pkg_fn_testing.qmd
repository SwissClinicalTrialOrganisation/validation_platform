...
the relevant [SCTO GitHub page](../wi/testing.qmd).
...
(`SCTORvalidation::test("packagename")`). Where packages from within the package itself are used, the [work instruction](../wi/running_tests.html.qmd#running-tests-from-within-a-package) provides additional information.
