...
Policy for R** [(LOCATION -- VERSION)]{.mark} and refers to the standard
operation procedure for Function testing (SCTO SOP -- Function testing
(in the SCTO statistics' platform; [LOCATION)]{.mark} of the SCTO
statistics platform.
...
-   ISO 31073:2022(en) Risk management --- Vocabulary:
    https://www.iso.org/obp/ui/en/#iso:std:iso:31073:ed-1:v1:en:term:3.1.3
